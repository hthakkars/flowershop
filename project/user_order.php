...
<?php
  ...
  $query = "SELECT *, o.user_id user_id FROM `order` o inner join `user` u using (user_id) WHERE o.user_id = $user_id ORDER BY o.received_dt desc";
  ...
  echo "  <div class=\"div-main\"> <h2>Orders</h2>";
  ...
  while ($result_ar = mysqli_fetch_assoc($result)) {
     ...
     echo "<td align=\"center\"><a href=\"viewUserOrder.php?id=" .$result_ar['order_id']. "\"><img src=\"images/view.png\"/></a></td>";
     echo "</tr>";
  }
  echo "</table>";
  echo "</div>";
